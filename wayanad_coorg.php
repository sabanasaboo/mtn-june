...
<html lang="en">
   <head>
      ...
      <title>Wayanad & Coorg Packages | Modern Tourism Network</title>
   </head>
   <body>
      ...
      <?php  include ("components/header.php")?>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(img/Wayanad-banner.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">Wayanad & Coorg Packages</h1>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-lg-8">
                        <div class="single-tour-inner">
                           <h2>EXPERIENCE THE NATURAL BEAUTY OF WAYANAD & COORG</h2>
                           <figure class="feature-image">
                              <img src="img/Wayanad-1.jpg" alt="">
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Wayanad-2.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Wayanad-3.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Wayanad-4.jpg" alt="">
                                    </figure>
                                 </div>
                              </div>
                           </div>
            ...
            <section class="subscribe-section" style="background-image: url(img/domestic-7.jpg);">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-7">
