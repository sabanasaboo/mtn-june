...
<html lang="en">
   <head>
      ...
      <title>Kashmir Packages | Modern Tourism Network</title>
   </head>
   <body>
      ...
      <?php  include ("components/header.php")?>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(img/Kashmir-banner.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">Kashmir Packages</h1>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-lg-8">
                        <div class="single-tour-inner">
                           <h2>EXPERIENCE THE NATURAL BEAUTY OF KASHMIR</h2>
                           <figure class="feature-image">
                              <img src="img/Kashmir-1.jpg" alt="">
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Kashmir-2.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Kashmir-3.webp" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Kashmir-4.webp" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Kashmir-5.jpg" alt="">
                                    </figure>
                                 </div>
                              </div>
                           </div>
            ...
            <section class="subscribe-section" style="background-image: url(img/Kashmir-6.webp);">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-7">
