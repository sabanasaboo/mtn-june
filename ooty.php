...
<html lang="en">
   ...
   <?php include ("components/head.html") ?>
      ...
      <title>Ooty Packages | Modern Tourism Network</title>
   </head>
   <body>
      ...
      <?php  include ("components/header.php")?>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(img/Ooty-banner.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">
                           Delightful Ooty Package
                           </h1>
                     </div>
                  </div>
               </div>
                              ...
                              <div class="tab-content" id="myTabContent">
                                 <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-content">
                                       <p>Discover the serene beauty of Ooty, nestled in the Nilgiri hills. From lush tea gardens to tranquil lakes, immerse yourself in nature's charm. Indulge in local cuisine, explore vibrant markets, and unwind amidst breathtaking landscapes. Ooty awaits, promising a refreshing escape like no other.</p>
                                       <ul class="mb-4">
                                         <li>- Group Trip</li> 
                                         <li>- Student Trip</li>
                                         <li>- Couple Trip</li>
                                       ...
                                       <ul>
                                          <li>- Ooty Bus Stop Pickup & Drop</li> 
                                       ...
                                       <ul class="mb-4">
                                          <li>- Ooty 2 Nights 3* Resort</li>
                                       </ul>
                                       <h4 class="blue">Cost Excludes</h4>
                                       <ul>
                                          <li>- Up & Doconvalliswn Transport</li> 
                                       ...
                                       <ul>
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Ooty Sightseeing</h4>
                                                <p>Pickup from Ooty Bus stop and drop to Ooty resort <br>After refreshing Start local sightseeing at Ooty Doddabetta Peak, Tea Museum, Botanical Garden, and Ooty Lake  & drop Resort @ 6 pm <br>Day 1 stay in Ooty </p>
                                             </div>
                                          </li>
                                          <li>
                                             <div class="timeline-content">
                                                <div class="day-count">Day <span>2</span></div>
                                                <h4>Pykara waterfalls & filmchakar</h4>
                                                <p>After Breakfast pickup, our cab to sightseeing @ 10.30 am
                                                   Pykara /  Pine Forest, Kamarajar Dam, 6th Mile, 9th Mile Film shooting point, Horse Ride Spot, Golf course, Pykara Falls, Pykara Lake (Boating) <br>Day 2-night stay in Ooty Resort</p>
                                             </div>
                                          </li>
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Coonoor</h4>
                                                <p>After Breakfast Check out the Hotel <br> Sightseeing activities for Coonoor -  Ketti Valley View, Sim's Park. <br>Evening drop to Ooty Busstop at 5 pm</p>
                                             </div>
                                          </li>
                                          <!-- <li>
                                             <div class="timeline-content">
                                 ...
                                 <div class="tab-pane" id="map" role="tabpanel" aria-labelledby="map-tab">
                                    <div class="map-area">
                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62575.05133735622!2d76.65222143224014!3d11.411849727025938!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba8bd84b5f3d78d%3A0x179bdb14c93e3f42!2sOoty%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1706704328028!5m2!1sen!2sin" height="450" allowfullscreen=""></iframe>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Ooty-2.png" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Ooty-3.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Ooty-4.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Ooty-5.webp" alt="">
                                    </figure>
                                 </div>
                              </div>
                           </div>
...
?>
                           ...
                           <!-- <div class="widget-bg booking-form-wrap">
                              ...
                              <form  action="ooty.php" class="booking-form" method="POST">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                       <div class="form-group">
                                          <input name="email_booking" type="email" name="email" placeholder="Email">
                                       </div>
                                    </div>
                                    <div class="col-sm-12">
                                       <div class="form-group">
            ...
            <section class="subscribe-section" style="background-image: url(img/Ooty-6.jpg);">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-7">
      ...
      <script>
         ...
         if(package==='honeymoon'){
            ...
            // let People= document.querySelectorAll('.package-meta ul')[0].childNodes[2].textContent
            // People.remove()
            // console.log(People);
