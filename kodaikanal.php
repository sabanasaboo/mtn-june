      ...
      <?php  include ("components/header.php")?>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(img/Kodaikanal-banner.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">Kodaikanal Leisure tour
                  ...
                  <div class="row">
                     <div class="col-lg-8">
                        <div class="single-tour-inner">
                           <h2>Best of kodaikanal</h2>
                           <figure class="feature-image">
                              <img src="img/Kodaikanal-1.jpg" alt="">
                              ...
                              <div class="tab-content" id="myTabContent">
                                 <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-content">
                                       <p>"Embark on a journey to the hill station paradise of Kodaikanal with our bespoke trip program. Lose yourself in the misty mountains, serene lakes, and verdant forests for an unforgettable escape into nature's embrace."</p>
                                       ...
                                       <div class="itinerary-content">
                                          ...
                                          <ul class="mb-4">
                                            ...
                                            <ul>
                                             <li>- Kodaikanal Bus Stop Pickup & Drop</li> 
                                            ...
                                            <ul class="mb-4">
                                               <li>-  Kodaikanal 2 Nights - 3* Resort</li>
                                            </ul>
                                       ...
                                       <ul>
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Kodaikanal Sightseeing</h4>
                                                <p> Pickup from Kodai Bus stop and drop to Kodai resort
                                                    After refreshing Start local sightseeing at Kodai
                                                   Kodaikanal Lake, Coakers Walk, Telescope House,
                                                   Shopping
                                                   Doddabetta Peak, Tea Museum, Botanical Garden and
                                                   drop cottage @ 6 pm
                                                    day 1 stay in Kodai Resort</p>
                                             </div>
                                          </li>
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Kodaikanal Sightseeing</h4>
                                                <p>After Breakfast proceed to the below Kodaikanal sightseeing
                                                   places:
                                                   Pillar Rocks,
                                                    Dolphin’s Nose,
                                                    Pine Forest,
                                                   ...
                                                   Bear Shola Falls,
                                                    Bryant Park,
                                                    Day 2-night stay in Kodai Resort
                                                   </p>
                                             </div>
                                          </li>
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Kodaikanal Sightseeing</h4>
                                                <p>After Breakfast Check out the Hotel
                                                    Chettiar Park,
                                                    Silver Cascade Waterfalls
                                                   Evening drop to Kodai Busstop at 6 pm</p>
                                             </div>
                                          </li>
                                       </ul>
                                    </div>
                                 ...
                                 <div class="tab-pane" id="map" role="tabpanel" aria-labelledby="map-tab">
                                    <div class="map-area">
                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31410.52236883724!2d77.4777206576196!3d10.236134685273003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b0766637f0a0387%3A0x9ffae9373758c13c!2sKodaikanal%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1708075320382!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Kodaikanal-3.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Kodaikanal-4.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Kodaikanal-5.webp" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Kodaikanal-6.jpg" alt="">
                                    </figure>
                                 </div>
                              </div>
                           </div>
...
//                 window.location.href = 'kodaikanal.php';
//             </script>
//         ";
//     } else {
//         echo "
...
<?php include ("components/normal-form.php") ?>
                              ...
                              <form class="booking-form" action="kodaikanal.php" method="POST">
                                 <div class="row">
            ...
            <section class="subscribe-section" style="background-image: url(img/Kodaikanal-7.jpg);">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-7">
