...
<html lang="en">
   ...
   <?php include('components/head.html')?>
      ...
      <title>Delhi EMI Packages | Modern Tourism Network</title>
   </head>
   <body>
      ...
      <?php  include ("components/header.php")?>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(img/delhi2.jpg) ;background-position: 0 -70px;">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title " >Beautiful Delhi & Agra
                        </h1>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-lg-8">
                        ...
                        <div class="single-tour-inner">
                           <h2>Breathtaking Delhi & Agra</h2>
                           <figure class="feature-image">
                              <img src="img/delhi.jpg" width="100%" alt="">
                              ...
                              <div class="tab-content" id="myTabContent">
                                 <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-content">
                                       <p>"Experience the vibrant heartbeat of India's capital city with our dynamic trip program to Delhi. From iconic landmarks like the Red Fort to bustling markets and delectable street food, delve into the rich tapestry of history, culture, and modernity in Delhi's embrace."</p>
                                       ...
                                       <ul>
                                        <li>- Delhi Airport Pickup And Drop</li> 
                                          <li>- Sightseeing by vehicle - 5 days</li>
                                       </ul>
                                       ...
                                       <ul>
                                          <li>Total Price - 12500 / Per Person</li> 
                                       </ul> -->
                                    </div>
                                 </div>
                                       ...
                                       <ul>
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Delhi Arrival – Sightseeing & Hotel Transfer</h4>
                                                <p>On your arrival at New Delhi Airport, transfer to the hotel and check in hotel and later visit
                                                    local sightseeing and stay at hotel
                                                     </p>
                                             </div>
                                          </li>
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <p>After breakfast, proceed for Sightseeing in Delhi. Visit Red Fort, Rajghat, India Gate,
                                                    Parliament House, Lotus Temple, and Humayun’s Tomb. Overnight stay at the hotel in Delhi.</p>
                                             </div>
                                          </li>
                                          <li>
                                             <div class="timeline-content">
                                                <div class="day-count">Day <span>3</span></div>
                                                <h4>  Delhi – Agra (Approx.210 Kms / 4 Hrs.)
                                                </h4>
                                                <p>After breakfast check out from the hotel and transfer to Agra, on arrival check-in, walkable
                                                    sightseeing, and shopping overnight stay at the Agra hotel.</p>
                                             </div>
                                          </li>
                                          <li>
                                             <div class="timeline-content">
                                                <div class="day-count">Day <span>4</span></div>
                                                <h4>Agra Sightseeing</h4>
                                                <p>After breakfast proceed for the sightseeing of Agra Visit Taj Mahal, Agra Fort. Agra Fort &
                                                    Itmad Ul Daula, back to the hotel Agra Hotel for an overnight stay.</p>
                                             </div>
                                          </li>
                                          <li>
                                             <div class="timeline-content">
                                                <div class="day-count">Day <span>5</span></div>
                                                <h4>Agra – Delhi Airport Transfer</h4>
                                                <p>After breakfast check out from the hotel and drive to Delhi on arrival, visit Akshardham
                                                    Temple and drop at Airport</p>
                                             </div>
                                          </li>
                                 ...
                                 <div class="tab-pane" id="map" role="tabpanel" aria-labelledby="map-tab">
                                    <div class="map-area">
                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d448193.951046296!2d76.76356261822156!3d28.644287349748506!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd5b347eb62d%3A0x37205b715389640!2sDelhi!5e0!3m2!1sen!2sin!4v1707803062016!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/delhi2.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/tajmahal-garden.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/delhi4.cms" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/tajmahal.jfif" alt="">
                                    </figure>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="package-price">
                              <h5 class="price">
                                ...
                                <p>Package cost starts from </p>
                                 ...
                                 <span>Rs 12,500</span>/ per person
                              </h5>
...
<?php include ("components/normal-form.php") ?>
                           ...
                           <!-- <div class="widget-bg booking-form-wrap">
                            ...
                            <form class="booking-form" action="delhi.php" method="post">
                               <div class="row">
                                  <div class="col-sm-12">
            ...
            <section class="subscribe-section" style="background-image: url(img/delhi4.avif);">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-7">
