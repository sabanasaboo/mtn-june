...
<form class="booking-form"  id="emiform1">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                <select id="emi-fromLocation" name="location" class="form-control rounded-0" style="box-shadow: none;" required>
                    ...
                    <option value="Umrah Economic Package  Ready cash">Umrah Economic Package  Ready cash</option>
                    <option value="Umrah Economic Package EMI">Umrah Economic Package EMI</option>
        ...
        <div class="col-sm-12">
            <div class="form-group">
                <input name="emiAmount" type="text" placeholder="Professional" required>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="form-group">
