...
<html lang="en">
   <head>
      ...
      <title>Kodaikanal Adventure | Modern Tourism Network</title>
   </head>
   <body>
      ...
      <?php  include ("components/header.php")?>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(img/ChennaiAdventure-banner.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">Kodaikanal Adventure</h1>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="row">
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="img/ScubaDiving.jpg" alt="">
                                 </a>
                              </figure>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="img/RockClimbing.jpg" alt="">
                                 </a>
                              </figure>
                              <div class="package-price">
                                 <h6>
                              ...
                              <div class="package-content-wrap">
                                 ...
                                 <div class="package-content">
                                    <h3>
                                       <a href="#"> Rock Climbing and Rappelling</a>
                                    </h3>
                                    <div class="review-area">
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="img/Off-roading.jpg" alt="">
                                 </a>
                              </figure>
                              <div class="package-price">
                                 <h6>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="img/Parasailing.jpg" alt="">
                                 </a>
                              </figure>
                              <div class="package-price">
                                 <h6>
