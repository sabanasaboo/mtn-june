...
<html lang="en">
   ...
   <?php include('components/head.html')?>
      ...
      <title>Yercaud Packages | Modern Tourism Network</title>
   </head>
   <body>
      ...
      <?php  include ("components/header.php")?>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(img/yercaud/yercaud-view.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">Weekend Yercaud</h1>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-lg-8">
                        <div class="single-tour-inner">
                           <h2>Yercaud Weekend Escape</h2>
                           <figure class="feature-image">
                              <img src="img/Yercaud-1.jpg" alt="">
                              ...
                              <div class="tab-content" id="myTabContent">
                                 <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-content">
                                       <p>"Discover the hidden gem of Yercaud nestled amidst the misty hills of Tamil Nadu with our exclusive trip program. Immerse yourself in the tranquility of lush coffee plantations, scenic viewpoints, and serene lakes for an unforgettable retreat in Yercaud."</p>
                                       ...
                                       <ul class="mb-4">
                                         ...
                                         <ul>
                                          <li>-Salem Railway station / Bus Stop Pickup & Drop</li> 
                                            <li>- Sightseeing 2 Days by 12 seater</li>
                                         </ul>
                                         <h4 class="mt-4">Food:</h4>
                                         <ul>
                                            <li>-Breakfast 1 Days</li>
                                            <!-- <li>- Dinner  3 Days</li> -->
                                         </ul>
                                         <h4 class="mt-4">Accommodation:</h4>
                                         <ul class="mb-4">
                                            <li>-  3* Resort with Fire camp
                                          </li>
                                         </ul>
                                 ...
                                 <div class="tab-pane" id="program" role="tabpanel" aria-labelledby="program-tab">
                                    <div class="itinerary-content">
                                       <h3>Program <span>( 2 days )</span></h3>
                                       <p>"Discover the hidden gem of Yercaud nestled amidst the misty hills of Tamil Nadu with our exclusive trip program. Immerse yourself in the tranquility of lush coffee plantations, scenic viewpoints, and serene lakes for an unforgettable retreat in Yercaud."</p>
                                       ...
                                       <ul>
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>- Salem – Yercaud</h4>
                                                <p> Morning pickup from Salem Railway station then transfer
                                                   to Yercaud and proceed to Emerald lake, Botanical
                                                   garden, Kiliyur falls, Lady's Seat, Pagoda point, Shevaroy
                                                   temple then check into hotel.
                                          ...
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <p>After breakfast check out from hotel then proceed to
                                                   Anna Park, Arthur's seat, Silk farm, Rose Garden, Bears
                                                   cave & Bears Hill etc and transfer to Salem drop to
                                                   railway station.
                                                   Back to chennai nextday morning</p>
                                             </div>
                                          </li>
                                 ...
                                 <div class="tab-pane" id="map" role="tabpanel" aria-labelledby="map-tab">
                                    <div class="map-area">
                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15623.446505722757!2d78.20970519999999!3d11.774792199999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3babf42b4747d5eb%3A0x1d3ccd9945d5e7ee!2sYercaud%2C%20Tamil%20Nadu%20636601!5e0!3m2!1sen!2sin!4v1708074838884!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/yercaud/Yercaud-kiliyur-falls.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/yercaud/Yercaud_lake.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Yercaud-2.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/Yercaud-3.jpg" alt="">
                                    </figure>
                                 </div>
                              </div>
                           </div>
...
//                 window.location.href = 'yercaud.php';
//             </script>
//         ";
//     } else {
//         echo "
...
?>
                           <!-- <div class="widget-bg booking-form-wrap">
                              ...
                              <form action="yercaud.php" method="post" class="booking-form">
            ...
            <section class="subscribe-section" style="background-image: url(img/Yercaud-5.jpg);">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-7">
