...
<html lang="en">
   ...
   <?php include('components/head.html')?>
      ...
      <title>Shimla EMI Packages | Modern Tourism Network</title>
   </head>
   <body>
      ...
      <?php  include ("components/header.php")?>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(img/shimla2.jpg); background-size: 100%;background-position: 0 -90px;">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title " >Experience Shimla & Manali Beauty</h1>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-lg-8">
                        ...
                        <div class="single-tour-inner">
                           <h2>Discover Shimla & Manali This Weekend</h2>
                              ...
                              <div class="tab-content" id="myTabContent">
                                 <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-content">
                                      <p> "Escape to the picturesque heights of Shimla with our meticulously curated trip program. Immerse yourself in the charming colonial architecture, snow-capped peaks, and pine-scented forests for a memorable mountain retreat in Shimla."</p>
                                       ...
                                       <ul>
                                        <li>- Chandigarh Airport Pickup & Drop</li> 
                                       ...
                                       <ul>
                                          <li>Total Price - 20000 / Per Person</li> 
                                       </ul> -->
                                    </div>
                                 </div>
                                       ...
                                       <ul>
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Arrival Chandigarh </h4>
                                                <p>- Pickup from Chandigarh
                                                   Airport/railway station
                                                   Transfer to Shimla.
                                                   Check in to Shimla Hotel.
                                                   Rest of the time is free for Individual activities.
                                          ...
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Shimla Full day sightseeing</h4>
                                                <p>
                                                   Today breakfast proceed for in and around sightseeing of
                                                   SHIMLA,
                                                   <br>
                                                   𝗦𝗵𝗶𝗺𝗹𝗮 𝗹𝗼𝗰𝗮𝗹 𝘀𝗶𝗴𝗵𝘁𝘀𝗲𝗲𝗶𝗻𝗴 :
                                                   • Viceregal Lodge
                                                   • Townhall
                                                   • Shimla Church
                                                   • Shimla Mall Road
                                          ...
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4> Shimla - Manali</h4>
                                                <p>
                                                   After Breakfast check out the Hotel, Transfer to Manali.
                                                   Enroute Kullu local sightseeing, Check into the Manali Hotel
                                                   <br>
                                                   𝗞𝘂𝗹𝗹𝘂 𝗹𝗼𝗰𝗮𝗹 𝘀𝗶𝗴𝗵𝘁𝘀𝗲𝗲𝗶𝗻𝗴 :
                                                   • Pandoh Dam
                                                   • Kullu Shawl Industry
                                                   • River Rafting Point
                                          ...
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4> Full Day Manali local sightseeing</h4>
                                                <p> 
                                                   Breakfast at hotel
                                                   <br>
                                                   𝐌𝐚𝐧𝐚𝐥𝐢 𝐥o𝐜𝐚𝐥 𝐬𝐢𝐠𝐡𝐭𝐬𝐞𝐞𝐢𝐧𝐠
                                                   • Beas River
                                                   • Club House
                                                   • Vanvihar
                                                   • Mall Road
                                          ...
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Manali- Chandigarh Airport</h4>
                                                <p>After Breakfast, Check out from Manali.
                                                   Transfer to Chandigarh Airport/railway station/bus stand</p>
                                             </div>
                                          </li>
                                          <!-- <li>
                                             <div class="timeline-content">
                                 ...
                                 <div class="tab-pane" id="map" role="tabpanel" aria-labelledby="map-tab">
                                    <div class="map-area">
                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11898564.801458942!2d71.12223004644045!3d32.73359546398603!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390578e3e35d6e67%3A0x1f7e7ff6ff9f54b7!2sShimla%2C%20Himachal%20Pradesh!5e0!3m2!1sen!2sin!4v1707803307197!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/shimla/manali-img1.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/shimla4.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/shimla/manani-img2.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                           ...
                           <div class="package-price">
                              <h5 class="price">
                                ...
                                <p>Package cost starts from </p>
                                 ...
                                 <span>Rs 20,000</span>/ per person
                              </h5>
...
//                 window.location.href = 'shimla.php';
//             </script>
//         ";
//     } else {
//         echo "
...
?>
                            <!-- <form action="shimla.php" method="post" class="booking-form">
            ...
            <section class="subscribe-section" style="background-image: url(img/shimla2.jpg);">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-7">
