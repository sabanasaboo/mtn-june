...
<html lang="en">
   ...
   <?php include('components/head.html')?>
      ...
      <title>Kerala Packages | Modern Tourism Network</title>
   </head>
   <body>
      ...
      <?php  include ("components/header.php")?>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(img/munnar-img4.jpeg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">
                          
                           Nature of Munnar and Thekkady 
                           </h1>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="col-lg-8">
                        <div class="single-tour-inner">
                           <h2>
                              ...
                              Munnar and Thekkady delight
                              </h2>
                           <figure class="feature-image">
                              <img src="img/munnar-img4.jpeg" alt="">
                              ...
                              <div class="tab-content" id="myTabContent">
                                 <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-content">
                                       <p>Embark on a journey of serenity and enchantment through Munnar lush landscapes and tranquil backwaters in our meticulously planned trip program. </p>
                                       <ul class="mb-4">
                                         <li>- Group Trip</li> 
                                         <li>- Student Trip</li>
                                         <li>- Couple Trip</li>
                                       ...
                                       <ul>
                                          ...
                                          <li>- Palani Railway station pickup & Drop
                                          </li>
                                       </ul>
                                       ...
                                       <ul class="mb-4">
                                          <li>  Munnar Mount Vally Resort or Similar - 2 Nights stay
                                          </li>
                                          <li>Honeymoon Decors - 1 Night
                                          </li>
                                          <li>Thekkady Planet stay or similar resort 1- Night stay
                                          </li>
                                       </ul>
                                       <h4 class="blue">Cost Excludes</h4>
                                       <ul class="li">
                                          <li>
                                             All kinds of personal expenses.<li>

                                          </li>Entry permits / Entry tickets wherever required in sightseeing</li>
                                       ...
                                       <ul>
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Munnar Sight seeing
                                                </h4>
                                                <p> Arrive in Munnar at 10.30 am and drop at Munnar Cottage After refreshing Start sightseeing
                                                   Echo point, Photo point, Mattupetty dam, Kundala Lake, drop cottage @ 6 pm,day 1 stay in Munnar
                                          ...
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Munnar </h4>
                                                <p>  After Breakfast our cab pickup for sightseeing,Tea museum, Rose Garden, Nyayamakad Falls, Attukad Falls, Blossom Hydel Park, Pothamedu viewpoint,day 2 stay in Munnar
                                          ...
                                          <li>
                                             <div class="timeline-content">
                                                ...
                                                <h4>Check out</h4>
                                                <p>
                                                   After Breakfast checkout the Hotel and onthe way sightseeing 
                                                   Drop at Cochin / Ernakulam Railway station
                                                   </p>
                                             </div>
                                          </li>
                                       </ul>
                                 ...
                                 <div class="tab-pane" id="map" role="tabpanel" aria-labelledby="map-tab">
                                    <div class="map-area">
                                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31425.795163046765!2d77.04357816160068!3d10.080691165420474!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b0799794d099a6d%3A0x63250e5553c7e0c!2sMunnar%2C%20Kerala%20685612!5e0!3m2!1sen!2sin!4v1709190981951!5m2!1sen!2sin"  height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/munnar-img1.jpeg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/munnar-img2.jpeg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/munnar-img-3.jpeg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
...
//                 window.location.href = 'munnar.php';
//             </script>
//         ";
//     } else {
//         echo "
...
// ?>
                           <!-- <div class="widget-bg booking-form-wrap">
                              ...
                              <form class="booking-form" action="munnar.php" method="post">
                                 <div class="row">
                                    <div class="col-sm-12">
            ...
            <section class="subscribe-section" style="background-image: url(img/Kerala-5.jpg);">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-7">
