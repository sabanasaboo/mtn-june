...
<html lang="en">
   <head>
      ...
      <title>Honeymoon Packages | Modern Tourism Network</title>
   </head>
   <body>
      ...
      <?php  include ("components/header.php")?>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(img/home-banner-1.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">Honeymoon Packages</h1>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="col-lg-8">
                        <div class="single-tour-inner">
                           ...
                           <figure class="feature-image">
                              <img src="img/domestic-8.jpg" alt="">
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/domestic-3.webp" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/domestic-2.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/domestic-1.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/domestic-4.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/domestic-5.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="img/domestic-6.webp" alt="">
                                    </figure>
                                 </div>
                              </div>
                           </div>
